...
bash 6_Classify_With_Quantum_Model.sh -t ./data/datasets/reduced_amazonreview_pre_alpha_train.tsv -v ./data/datasets/reduced_amazonreview_pre_alpha_test.tsv -s {{ s }} -r {{ r }} -i {{ i }} -p {{ p }} -o ./benchmarking/results/raw/
