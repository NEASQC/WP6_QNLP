...
sys.path.append(current_path + "/../neasqc_wp61/models/quantum/alpha_3/")
        ...
        for ansatz in ansatze_list:
            for init in initialisations_list:
                ...
                params_run.extend(
                    ...
                    vectors, labels_one_hot_encoding, n_classes,
                    circuit, optimiser, epochs, batch_size,
                    lr, test_args['seed'], init, init, vector_length,
...
names_parameters = (
    'alpha_3_model', 'vectors', 'labels_one_hot_encoding', 'n_classes',
    'circuit', 'optimiser', 'epochs', 'batch_size', 'lr', 'seed',
    'init_qubits', 'init_mlp', 'vector_length', 'ansatz', 'n_layers',
...
class TestAlpha3(unittest.TestCase):
    def test_model_raises_errors_if_number_of_qubits_is_not_correct(
        ...
        with self.assertRaises(ValueError):
            alpha_3_model = alpha_3(
                ...
                self.seed, self.init_qubits, self.init_mlp
            )
    ...
    def test_model_raises_error_if_out_probabilities_true_in_circuit(
        ...
        circuit = self.ansatz(
            ...
            self.observables, output_probabilities = True
        )
        with self.assertRaises(ValueError):
            alpha_3_model = alpha_3(
                self.vectors, self.labels_one_hot_encoding, self.n_classes,
